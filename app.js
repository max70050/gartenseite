...
const backendUrl = 'https://daeli-backend.onrender.com'; // Deine Render-URL
let elements;
...
checkoutBtn.addEventListener('click', () => {
    ...
    document.getElementById('start-online-payment-btn').style.display = 'block';
...
async function initializeCheckout() {
    startOnlinePaymentBtn.textContent = 'Lade Bezahloptionen...';
